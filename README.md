...
We normalize across all pairs by dividing by the maximum raw score observed, bringing every value into [0, 1]. More interaction → smaller distance:
