...
| DIST-01 | Phase 2 | Core Algorithm | Complete |
| DIST-02 | Phase 2 | Core Algorithm | Complete |
| DIST-03 | Phase 2 | Core Algorithm | Complete |
| DIST-04 | Phase 2 | Core Algorithm | Complete |
...
| ORIG-01 | Phase 2 | Core Algorithm | Complete |
| ORIG-02 | Phase 2 | Core Algorithm | Complete |
| ORIG-03 | Phase 2 | Core Algorithm | Complete |
