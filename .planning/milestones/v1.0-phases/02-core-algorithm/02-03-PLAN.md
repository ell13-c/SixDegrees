...
must_haves:
  truths:
    ...
    - "Tier assignment uses 2D Euclidean distances from translated coordinates — Tier 1 = 5 nearest, Tier 2 = ranks 6-15, Tier 3 = all remaining (get_ranked_matches() not used — it has a 0.75 cutoff that would drop users)"
  ...
  key_links:
    ...
    - from: "backend/services/map_pipeline/origin_translator.py"
      to: "numpy"
      via: "import numpy as np — Euclidean distance via np.sqrt(translated[:,0]**2 + translated[:,1]**2)"
