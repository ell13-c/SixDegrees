...
class TestEdgeCountCalculation:
    def test_edge_count_counts_nonzero_pairs(self):
        interactions = [
            {"like_count": 2, "comment_count": 0, "dm_count": 0},   # has likes → count
            {"like_count": 0, "comment_count": 0, "dm_count": 0},   # all zeros → skip
            {"like_count": 0, "comment_count": 3, "dm_count": 0},   # has comments → count
        ]
    ...
    def test_edge_count_in_record_run(self):
        interactions = [
            {"like_count": 1, "comment_count": 0, "dm_count": 0},
            {"like_count": 0, "comment_count": 0, "dm_count": 0},
            {"like_count": 0, "comment_count": 1, "dm_count": 0},
        ]
        mock_input = _make_pipeline_input(interactions=interactions)
